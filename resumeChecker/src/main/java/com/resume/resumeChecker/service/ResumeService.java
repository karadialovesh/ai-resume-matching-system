...
public class ResumeService {
    ...
    public EvaluationResponse processTextResume(UUID jobId,
                                                String name,
                                                String email,String resumetext) {
        ...
        return evaluateAndStore(job, name, email, resumetext, "TEXT");
    }
    ...
    public EvaluationResponse processPdfResume(UUID jobId,
                                               ...
                                               String email,
                                               MultipartFile file) {
        System.out.println("Processing pdf start");
        ...
        System.out.println("Processing pdd " + " "+content);
        System.out.println("Processing pdf end+ final stage");
    ...
    private EvaluationResponse evaluateAndStore(JobDescription job,
                                                ...
                                                String content,
                                                String type) {
        System.out.println("Evaluating process");
